...
#define WIFI_PASSWORD "Lollypop5050"        // WIFI password here
...
void loop(){
  ...
  if (digitalValue > 0){
   ...
   http.begin(wclient, "http://youngancient.000webhostapp.com/dblwrite.php");              // Connect to host where MySQL databse is hosted
