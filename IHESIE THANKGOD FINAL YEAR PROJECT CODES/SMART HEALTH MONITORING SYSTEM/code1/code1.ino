...
#define HOST "XXXXXXXX"          // Enter HOST URL without "http:// "  and "/" at the end of URL
...
void loop(){
  ...
  float temperatureF = sensors.getTempFByIndex(0);
   ...
   http.begin(wclient, "http://XXXXXXX/dbwrite.php");              // Connect to host where MySQL databse is hosted
