...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+234\"\r"); // input mobile number according to country's code
  delay(200);
  mySerial.println("Danger! gas leak detected at 82 Awolowo Rd,Railway Compund, Ebute-Metta, Lagos. These are GPS cordinates of the site in latitude and longitude respectively ");// The SMS text you want to send
...
void SendMessage2()
{
  ...
  mySerial.println("AT+CMGS=\"+234\"\r"); // input mobile number according to country's code
  delay(200);
  mySerial.println("Danger! Gas leak detected at this location.");// The SMS text you want to send
  delay(100);
  Serial.println ("Finish");
  mySerial.println((char)26);// ASCII code of CTRL+Z
  delay(200);
